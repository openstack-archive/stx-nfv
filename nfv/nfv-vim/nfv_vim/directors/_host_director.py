...
class HostDirector(object):
    ...
    def _nfvi_disable_host_services(self, host_uuid, host_name,
                                    host_personality, disable_func, service):
        """
        NFVI Disable Host Services
        """
        disable_func(host_uuid, host_name, host_personality,
                     self._nfvi_disable_host_services_callback(service))
    ...
    def _nfvi_enable_host_services(self, host_uuid, host_name,
                                   host_personality, enable_func, service):
        """
        NFVI Enable Host Services
        """
        enable_func(host_uuid, host_name, host_personality,
                    self._nfvi_enable_host_services_callback(service))
    ...
    def disable_host_services(self, host_names, service):
        ...
        for host in host_list:
            disable_func = host.disable_host_services_func(service)
            self._nfvi_disable_host_services(
                host.uuid, host.name, host.personality,
                disable_func, service)
    ...
    def enable_host_services(self, host_names, service):
        ...
        for host in host_list:
            enable_func = host.enable_host_services_func(service)
