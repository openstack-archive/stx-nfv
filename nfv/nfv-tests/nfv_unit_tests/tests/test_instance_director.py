...
def create_instance(instance_type_name, instance_name, recovery_priority=None):
    """
    Create an instance
    """
...
@mock.patch('nfv_common.timers.timers_create_timer')
...
def test_instance_director_recovery_list(
    ...
    tables_get_tenant_table_mock.return_value = _tenant_table
...
def test_instance_director_recovery_list_order(
    ...
    instance_2 = create_instance('small', 'instance_2')
    ...
    instance_3 = create_instance('small', 'instance_3', recovery_priority=5)
    ...
    instance_4 = create_instance('small', 'instance_4', recovery_priority=1)
    ...
    instance_5 = create_instance('small', 'instance_5', recovery_priority=10)
...
def test_instance_director_recover_instance(
    ...
    _director._is_host_enabled = mock.Mock(return_value=True)
    _director._is_hypervisor_enabled = mock.Mock(return_value=True)
    _director.upgrade_inprogress = mock.Mock(return_value=False)
